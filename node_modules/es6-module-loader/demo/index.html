...
<body>
	<div role="main">
		...
		<p>Check the console in your browser developer tools! This code is
			currently loaded in the page:</p>
		<pre>
  ...
  &lt;/script>
		...
		<p>Note that if you click on the button again, a new Foo module
			will be created, but 'test2' will not be reloaded.</p>
	</div>
	<footer> </footer>
