...
<body ng-app="BrowserSync">
	...
	<section bs-container>
		...
		<section bs-sidebar>
			...
			<nav bs-section-nav
				ng-class="{'active': app.ui.sectionMenu, ready: true}">
				<ul bs-list="stacked">
					<li ng-class="{'active': item.active}"
						ng-repeat="(key, item) in app.ui.menu | orderObjectBy: 'order'">
						<button bs-button ng-class="{'active': item.active}"
							ng-click="app.setActiveSection(item)">
