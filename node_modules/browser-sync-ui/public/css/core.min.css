...
[bs-button]:focus, [bs-button]:hover, [bs-header] [bs-list~=header] a:hover,
	[bs-header] [bs-list~=header]:hover, a, a [class*=" icon-"], a [class^=icon-],
	ins, u {
	text-decoration: none
}

[bs-header], [bs-header] [bs-header-row], main, sub, sup {
	position: relative
}

[bs-header] [bs-header-row~=brand], [bs-toggle] {
	height: 60px
}
...
[bs-sidebar], [bs-toggle]:hover {
	background: #444
}

[bs-panel] [bs-text~=prefixed], button, select {
	text-transform: none
}

[bs-content], body, html {
	overflow-x: hidden
}

[bs-button], [rowspan], button, input, select {
	vertical-align: middle
}

[bs-list], [bs-list~=inline-controls] {
...
blockquote, caption, dd, dl, fieldset, form, h1, h2, h3, h4, h5, h6, hr,
	legend, ol, p, pre, table, td, th, ul {
	margin: 0;
	padding: 0
}
...
@font-face {
	...
	src: url(../fonts/source-sans/sourcesanspro-it-webfont.eot?#iefix)
		format('embedded-opentype'),
		url(../fonts/source-sans/sourcesanspro-it-webfont.woff2)
		format('woff2'),
		url(../fonts/source-sans/sourcesanspro-it-webfont.woff) format('woff'),
		url(../fonts/source-sans/sourcesanspro-it-webfont.ttf)
		format('truetype'),
		url(../fonts/source-sans/sourcesanspro-it-webfont.svg#source_sans_proitalic)
		format('svg');
	font-weight: 400;
	font-style: italic
}
...
@font-face {
	...
	src: url(../fonts/source-sans/sourcesanspro-bold-webfont.eot?#iefix)
		format('embedded-opentype'),
		url(../fonts/source-sans/sourcesanspro-bold-webfont.woff2)
		format('woff2'),
		url(../fonts/source-sans/sourcesanspro-bold-webfont.woff)
		format('woff'),
		url(../fonts/source-sans/sourcesanspro-bold-webfont.ttf)
		format('truetype'),
		url(../fonts/source-sans/sourcesanspro-bold-webfont.svg#source_sans_probold)
		format('svg');
	font-weight: 700;
	font-style: normal
}
...
@font-face {
	...
	src: url(../fonts/source-sans/sourcesanspro-regular-webfont.eot?#iefix)
		format('embedded-opentype'),
		url(../fonts/source-sans/sourcesanspro-regular-webfont.woff2)
		format('woff2'),
		url(../fonts/source-sans/sourcesanspro-regular-webfont.woff)
		format('woff'),
		url(../fonts/source-sans/sourcesanspro-regular-webfont.ttf)
		format('truetype'),
		url(../fonts/source-sans/sourcesanspro-regular-webfont.svg#source_sans_proregular)
		format('svg');
	font-weight: 400;
	font-style: normal
}
...
[bs-toggle] svg[bs-state=alt], [bs-toggle].active svg {
	opacity: 0
}
...
@media only screen and (min-width:600px) {
	...
	[bs-sidebar]:after {
		...
		top: 0;
		z-index: 10;
		background: -webkit-linear-gradient(left, transparent 0, rgba(0, 0, 0, .2)
			100%);
		background: linear-gradient(to right, transparent 0, rgba(0, 0, 0, .2)
			100%)
	}
}
...
address, blockquote, details, dl, fieldset, figcaption, figure, h1, h2,
...
[bs-button-group], [bs-button], [bs-stack] {
	margin-bottom: 14px
}
...
[bs-button], [bs-control], [bs-footer], [bs-notify], [bs-overlay], [bs-tag]
	{
	text-align: center
}
...
[bs-button~=subtle]:focus, [bs-button~=subtle-alt]:focus {
	background: #fff
}
...
@media only screen and (min-width:600px) {
	...
	[bs-action~=menu-toggle], [bs-action~=menu-close] {
		display: none
	}
}
...
[bs-code-input], [bs-input~=text] input {
	font-family: monospace
}
...
@
-webkit-keyframes load1 { 0%,100%,80%{
	box-shadow: 0 0 #333;
	height: 4em
}
...
[bs-flush], [bs-list] p, [bs-list~=inline-controls] [bs-button-group] {
	margin-bottom: 0
}
...
.cmn-toggle, [bs-notify], [bs-overlay], [bs-state-icons] [bs-svg-icon] {
	position: absolute
}
