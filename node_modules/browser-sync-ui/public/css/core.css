...
@font-face {
	...
	src: url('../fonts/source-sans/sourcesanspro-it-webfont.eot?#iefix')
		...
		format('woff2'),
		url('../fonts/source-sans/sourcesanspro-it-webfont.woff')
		format('woff'),
...
@font-face {
	...
	src:
		url('../fonts/source-sans/sourcesanspro-regular-webfont.eot?#iefix')
		format('embedded-opentype'),
...
html {
	...
	overflow-y: auto;
	height: 100%;
	font: 112.5%/1.5 "source_sans", "Lucida Grande", "Lucida Sans",
		sans-serif;
	-webkit-text-size-adjust: 100%;
	-ms-text-size-adjust: 100%;
...
@media only screen and (min-width: 600px) {
	...
	[bs-sidebar]:after {
		...
		top: 0;
		z-index: 10;
		background: -webkit-linear-gradient(left, transparent 0%, rgba(0, 0, 0, 0.2)
			100%);
		background: linear-gradient(to right, transparent 0%, rgba(0, 0, 0, 0.2)
			100%);
	}
}
...
h1, h2, h3, h4, h5, h6, hgroup, p, blockquote, address, ul, ol, dl,
	table, fieldset, figure, figcaption, details, pre {
	margin-bottom: 14px;
}
