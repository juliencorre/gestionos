...
.network-sidebar .data-grid table.data {
	...
	background-image: -webkit-gradient(linear, left top, left bottom, from(rgba(0, 0, 0, 0)),
		color-stop(0.5, rgba(0, 0, 0, 0)), color-stop(0.5, rgba(0, 0, 0, 0.05)),
		to(rgba(0, 0, 0, 0.05)));
	font-size: 11px;
}
...
.network-sidebar .data-grid th, .network.panel .data-grid th.sort-descending,
...
.network-sidebar .data-grid td.method-column, .network-sidebar .data-grid td.status-column,
	.network-sidebar .data-grid td.type-column, .network-sidebar .data-grid td.size-column,
	.network-sidebar .data-grid td.time-column {
	background-color: rgba(0, 0, 0, 0.07);
}

.network-sidebar .data-grid td.size-column, .network-sidebar .data-grid td.time-column
	{
	text-align: right;
}
...
.data-grid.filter-all table.data tr.revealed.network-item, .data-grid.filter-documents table.data tr.revealed.network-category-documents,
...
/* Viewer */
.network.panel.viewing-resource .network-sidebar .data-grid td, .network.panel.viewing-resource .network-sidebar .data-grid th
	{
	border-right: none;
}
...
.network-item-view .tabbed-pane-header {
	height: 20px;
	background: -webkit-gradient(linear, 0% 0%, 0% 100%, from(rgb(236, 236, 236)),
		to(rgb(217, 217, 217)));
...
.resource-timing-view .network-timing-bar.proxy {
	background-image: -webkit-gradient(linear, left top, left bottom, from(rgb(239, 228, 176)),
		to(rgb(139, 128, 76)));
	border-left: 1px solid rgb(139, 128, 76);
}

.resource-timing-view .network-timing-bar.dns {
	background-image: -webkit-gradient(linear, left top, left bottom, from(rgb(153, 208, 216)),
		to(rgb(81, 174, 189)));
	border-left: 1px solid rgb(81, 174, 189);
}

.resource-timing-view .network-timing-bar.connecting {
	background-image: -webkit-gradient(linear, left top, left bottom, from(rgb(203, 232, 145)),
		to(rgb(160, 214, 56)));
	border-left: 1px solid rgb(160, 214, 56);
}

.resource-timing-view .network-timing-bar.ssl {
	background-image: -webkit-gradient(linear, left top, left bottom, from(rgb(21, 232, 145)),
		to(rgb(216, 149, 132)));
	border-left: 1px solid rgb(216, 149, 132);
}

.resource-timing-view .network-timing-bar.sending {
	background-image: -webkit-gradient(linear, left top, left bottom, from(rgb(232, 192, 182)),
		to(rgb(216, 147, 130)));
	border-left: 1px solid rgb(216, 147, 130);
}

.resource-timing-view .network-timing-bar.waiting {
	background-image: -webkit-gradient(linear, left top, left bottom, from(rgb(188, 179, 208)),
		to(rgb(141, 125, 175)));
	border-left: 1px solid rgb(141, 125, 175);
}

.resource-timing-view .network-timing-bar.receiving {
	background-image: -webkit-gradient(linear, left top, left bottom, from(rgb(214, 214, 214)),
		to(rgb(182, 182, 182)));
